export const HERO_CONTENT = {
	title: "Take Control of Your Journey With ",
	highlight: "UniRoute",
	subtitle: "Plan smarter, track your courses, and graduate with confidence.",
};

export const ABOUT_CONTENT = {
	title: "What is UniRoute?",
	subtitle: "UniRoute the most effective way to manage your courses.",
	description:
